# CMIP7 experiment description scratch
...
Having set up your environment, the docs can be served locally with

```sh
uv run mkdocs serve
```

You can then point your browser at the link that is shown
(e.g. http://127.0.0.1:8000/)
and you will see the docs.
